                        ...
                        <View style={styles.origin} key={index}>
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    ...
                                    <View >
                                        {likedProducts[index] ? <Entypo onPress={() => handleUnlike(index, data)} name="heart" size={40} color="red" /> : <Entypo onPress={() => handleLike(index, data)} name="heart-outlined" size={40} color="#555555" />}
                                    </View>
                                </View>
                            </View>
                        </View>
